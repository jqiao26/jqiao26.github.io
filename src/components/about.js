    ...
    <div style={{ cursor: isHovered ? "pointer" : "default" }}>
      ...
      <p className="text-2xl mt-4 font-poppins text-center">
        ...
        >
         ...
         working at <a href="https://teleskope.ai" target="_blank" rel="noreferrer" class="text-lightcobaltblue cursor-pointer hover:underline decoration-lightcobaltblue decoration-2">Teleskope</a>
      </p>
      <div style={{ height: "400px" }}>
        <Canvas className="canvas" dpr={[1, 2]}>
          <Blob isHovered={isHovered} setIsHovered={setIsHovered} toggleBackground={setBg} />
        </Canvas>
      </div>
    </div>
  );
